...
function CodeActionMenuContainer({
  ...
  return (
    <>
      {isShown ? (
        <div
          className="code-action-menu-container user-select-none text-neutral-950/50 absolute flex h-9 flex-row items-center space-x-1 text-xs dark:text-neutral-50/50"
          style={{ ...position }}
        >
