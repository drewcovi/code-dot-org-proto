...
export default function LearningStyleIntro() {
  ...
  return (
    <>
      ...
      <div className="row-start-2 grid grid-cols-12 text-left flex flex-col grow-1 center items-center content-center grow-1 overflow-y-scroll">
        <div className="mb-30 col-span-8 col-start-3 flex flex-col bg-gray-200 p-12 rounded-xl self-center">
          {/* <h2 className="text-xl font-bold"></h2> */}
          <p className="my-3">
            To get to know you a little better, we have a few quick questions
            about your style and preferences.
          </p>
          <p className="my-3">
            With this information we can work better to match you during group
            activites and work with your teacher to streamline your experience.
          </p>
          <p className="my-3">
            If at any point you would like to change these answers, you can
            visit your profile page to make updates.
          </p>
