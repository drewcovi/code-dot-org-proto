...
const questionGroups = [
  {
    ...
    questions: [
      {
        id: "vark",
        title: "1. How do you prefer to learn new concepts (like how to use a new app or ride a bike)?",
        options: [
          { label: "Watch a video or look at diagrams", value: "visual", image: "/images/visual.png" },
          { label: "Ask someone to explain it to you", value: "auditory", image: "/images/auditory.png" },
          { label: "Read the instructions", value: "reading", image: "/images/reading.png" },
          { label: "Try it hands-on", value: "kinesthetic", image: "/images/kinesthetic.png" },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { label: "Prefer to work alone", value: "independent", image: "/images/independent.png" },
          { label: "Like when others guide you", value: "dependent", image: "/images/dependent.png" },
          { label: "Compete to stand out", value: "competitive", image: "/images/competitive.png" },
          { label: "Enjoy collaborating equally", value: "collaborative", image: "/images/collaborative.png" },
          { label: "Avoid them when possible", value: "avoidant", image: "/images/avoidant.png" },
          { label: "Like leading or helping others", value: "participant", image: "/images/participant.png" },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { label: "Solving puzzles", value: "logical", image: "/images/logical.png" },
          { label: "Writing poems or stories", value: "linguistic", image: "/images/linguistic.png" },
          { label: "Drawing or designing", value: "spatial", image: "/images/spatial.png" },
          { label: "Playing an instrument or dancing", value: "musical", image: "/images/musical.png" },
          { label: "Hanging out with friends or helping others", value: "interpersonal", image: "/images/interpersonal.png" },
          { label: "Thinking about your feelings or journaling", value: "intrapersonal", image: "/images/intrapersonal.png" },
          { label: "Hiking, gardening, or caring for animals", value: "naturalistic", image: "/images/naturalistic.png" },
        ],
      },
    ],
  },
 ...
 {/* FOOTER ACTIONS */}
       ...
       <Footer>
        ...
        (<>
          ...
          onClick={handleBack}
          disabled={step === 0}
          className={`px-8 py-4 rounded-xl ${step === 0 ? "bg-gray-300 text-gray-700" : "bg-gray-600 text-white hover:bg-gray-700"}`}
        >Back</button>
