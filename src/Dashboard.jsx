...
export default function Dashboard() {
    ...
    {/* Main Content */
    } <main className= "bg-gray-100 p-6 grid-cols-subgrid lg:grid-cols-12 md:grid-cols-8 gap-x-10 grid font-sans overflow-y-auto row-start-3 gap-y-6 grid-rows-[auto_1fr]" >
        <h2 className="order-first text-3xl font-semibold lg:col-span-12 col-span-8 flex justify-content content-center row-start-1">
        ...
        <div className= "order-1 grid gap-6 md:grid-cols-1 lg:grid-cols-2 lg:col-span-8 md:col-span-4" > {
        ...
        <div className="order-last grid lg:col-start-9 md:col-span-4 md:col-start-5">
          <div className="overflow-hidden bg-white rounded-xl p-6 shadow hover:shadow-md transition">
